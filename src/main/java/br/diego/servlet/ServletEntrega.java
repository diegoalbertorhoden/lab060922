...
public class ServletEntrega extends HttpServlet {
	...
	//SEGUINDO A SOLICITAÇÃO QUE EU NÁO HAVIA ENTENDIDO COM O EXEMPLO DO QUICKSTART
	//TEMOS NAVEGADOR> SERVLET E AGORA VOU PRECISAR DOS EJB AQUI PRA IR DPS PRO DESTINO...
